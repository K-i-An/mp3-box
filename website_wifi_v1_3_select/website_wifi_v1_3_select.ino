...
<body>
  ...
  <ul>
    ...
    <li><a href='/select?folder=37'>37. Das Lied von Eis und Feuer</a></li>
    <li><a href='/select?folder=38'>38. Der Herr der Ringe</a></li>
    <li><a href='/select?folder=39'>39. Die Elfensaga</a></li>
    <li><a href='/select?folder=40'>40. Tom und das Königsschloss</a></li>
...
void handleSelect()
{
  if (server.hasArg("folder")) {
    ...
    if (folder >= 1 && folder <= 46) {
      ...
      myDFPlayer.loopFolder((uint8_t)folder);
      selFolder = folder;
...
void handleStatus()
{
  ...
  html += "<p><b>Datei:</b> " + String(myDFPlayer.readCurrentFileNumber()) + "</p>";
...
void selectFolder() {
  if (selFolder > 0) {
    myDFPlayer.loopFolder((uint8_t)selFolder);
...
// ====== RFID-Tabelle ======
void saveRFIDTable() {
  listUID[0].uid = "1dfdf2cb930000"; listUID[0].folderID = 1;   // Mulan
  listUID[1].uid = "1dbac8cb930000"; listUID[1].folderID = 2;   // TKKG
  listUID[2].uid = "04c5f521110189"; listUID[2].folderID = 3;   // Gloeckner
  listUID[3].uid = "04956422110189"; listUID[3].folderID = 4;   // Peter Pan
  listUID[4].uid = "04bbb921110189"; listUID[4].folderID = 5;   // Sally
  listUID[5].uid = "04f98a21110189"; listUID[5].folderID = 6;   // Pocahontas
  listUID[6].uid = "048bf621110189"; listUID[6].folderID = 7;   // Barbie
  listUID[7].uid = "04b8c821110189"; listUID[7].folderID = 8;   // Dornroesschen
  listUID[8].uid = "04ce1d22110189"; listUID[8].folderID = 9;   // Raya
  listUID[9].uid = "041c7321110189"; listUID[9].folderID = 10;  // Rapunzel
  listUID[10].uid = "9673df5f"; listUID[10].folderID = 11;      // Schoene & Biest
  listUID[11].uid = "9e496b1d"; listUID[11].folderID = 12;      // Aladin
  listUID[12].uid = "11aeb789"; listUID[12].folderID = 13;      // Tarzan
  listUID[13].uid = "808be112"; listUID[13].folderID = 14;      // Prinz Agypten
  listUID[14].uid = "1dc0b394680000"; listUID[14].folderID = 15;// Vaiana
  listUID[15].uid = "1dd8b394680000"; listUID[15].folderID = 16;// Koenig der Loewen
  listUID[16].uid = "1dd5b394680000"; listUID[16].folderID = 17;// Luca
  listUID[17].uid = "1dfbb394680000"; listUID[17].folderID = 18;// Casper
  listUID[18].uid = "1dfab394680000"; listUID[18].folderID = 19;// Harry Potter
  listUID[19].uid = "1de4b394680000"; listUID[19].folderID = 20;// Black Pink
  listUID[20].uid = "1de0b394680000"; listUID[20].folderID = 21;// Lea
  listUID[21].uid = "1dfdb394680000"; listUID[21].folderID = 22;// Lina
  listUID[22].uid = "1d82b394680000"; listUID[22].folderID = 23;// Bibi & Tina
  listUID[23].uid = "1d7fb394680000"; listUID[23].folderID = 24;// Herkules
  listUID[24].uid = "1d2bdbcb930000"; listUID[24].folderID = 25;// Encanto
  listUID[25].uid = "04504f21110189"; listUID[25].folderID = 26;// Emmi
  listUID[26].uid = "04881422110189"; listUID[26].folderID = 27;// Bobo
  listUID[27].uid = "1d49d4cb930000"; listUID[27].folderID = 28;// Gute Nacht
  listUID[28].uid = "1d4fe5cb930000"; listUID[28].folderID = 29;// Party
  listUID[29].uid = "1227ae89"; listUID[29].folderID = 30;      // Super Simple Songs
  listUID[30].uid = "eeac901d"; listUID[30].folderID = 31;      // Worship
  listUID[31].uid = "1d00cbcb930000"; listUID[31].folderID = 32;// Workout
  listUID[32].uid = "1d73edcb930000"; listUID[32].folderID = 33;// 5 Geschwister
  listUID[33].uid = "1da4d4cb930000"; listUID[33].folderID = 34;// Gaensehaut
  listUID[34].uid = "1dd4e3cb930000"; listUID[34].folderID = 35;// 5 Freunde
  listUID[35].uid = "1dc1dacb930000"; listUID[35].folderID = 36;// Die 3 ???
  listUID[36].uid = "1d8f3930880000"; listUID[36].folderID = 37;// Das Lied von Eis und Feuer
  listUID[37].uid = "1d712c30880000"; listUID[37].folderID = 38;// Der Herr der Ringe
  listUID[38].uid = "1de94330880000"; listUID[38].folderID = 39;// Die Elfensaga
  listUID[39].uid = "1d5f1b30880000"; listUID[39].folderID = 40;// Tom und das Königsschloss
  listUID[40].uid = "1d2d4030880000"; listUID[40].folderID = 41;//
  listUID[41].uid = "1d852530880000"; listUID[41].folderID = 42;//
  listUID[42].uid = "1dea2f30880000"; listUID[42].folderID = 43;//
  listUID[43].uid = "1d182230880000"; listUID[43].folderID = 44;//
  listUID[44].uid = "1d854030880000"; listUID[44].folderID = 45;//
  listUID[45].uid = "1d882c30880000"; listUID[45].folderID = 46;//
}
...
int getUIDFolder(String uid) {
  ...
  Serial.print("Unbekannte UID: "); Serial.println(uid);
  return -1;
}

void printDetail(uint8_t type, int value) {
  if (type == DFPlayerError) {
    Serial.print(F("DFPlayerError: ")); Serial.println(value);
  }
}
